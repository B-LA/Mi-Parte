...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class=" col-md-7">
                    <f:form action="${action}" method="POST" modelAttribute="gerente">
                        ...
                        <div class="well well-sm"><strong><span
                            ...
                            <label for="idgerente">Codigo del Gerente:</label>
                            <div class="input-group">
                                <f:input path="idgerente" cssClass="form-control" readonly="true"/>
                        ...
                        <f:button class="btn btninfo">
                            Guardar</f:button>
                        <a class="btn btn-danger" href="<s:url
                               value="/gerente/list"/>">Cancelar</a>
                    </f:form>
                </div>
            </div>
        </div>
